...
public class AfterSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reviewExist = intent.getStringExtra("reviewExist");
        ...
        if(reviewExist.equals("1")){
            Log.d("reviewKey : ", "있음");
            searchword = intent.getStringExtra("reviewSearch");
            new ServerConnect(address1, address2, address3,
                    price1, area1, price2, area2, searchword).execute("http://13.125.87.255:3000/houseSearchs");
        }
        else if(reviewExist.equals("0")){
            Log.d("reviewKey : ", "없음");
            new ServerConnect4(address1, address2, address3,
                    price1, area1, price2, area2).execute("http://13.125.87.255:3000/houseSearchkey");
        }
    ...
    public class ServerConnect extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                new ServerConnect2(address1, address2, address3,
    ...
    public class ServerConnect2 extends AsyncTask<String, String, String> {
        ...
        public ServerConnect2(String address1, String address2, String address3, String price1, String area1, String price2, String area2, String reviewSearch){
            this.address1 = address1;
            this.address2 = address2;
            this.address3 = address3;
            this.price1 = price1;
            ...
            try {
                if(result == null){
                    ...
                    for(int i =0; i< jsonArray.length(); i++) {
                        ...
                        Log.d("House(2)" + i + ":", houseList.get(i).toString());
                    }
                }
                ...
                new ServerConnect3(address1, address2, address3,
                        price1, area1, price2, area2, searchword).execute("http://13.125.87.255:3000/houseSearchss");
            } catch (JSONException e) {
                e.printStackTrace();
            }
    ...
    public class ServerConnect3 extends AsyncTask<String, String, String> {
        ...
        public ServerConnect3(String address1, String address2, String address3, String price1, String area1, String price2, String area2, String reviewSearch){
            this.address1 = address1;
            this.address2 = address2;
            this.address3 = address3;
            this.price1 = price1;
    ...
    public class ServerConnect4 extends AsyncTask<String, String, String> {
        ...
        public ServerConnect4(String address1, String address2, String address3, String price1, String area1, String price2, String area2){
            this.address1 = address1;
            this.address2 = address2;
            this.address3 = address3;
            this.price1 = price1;
            ...
            try {
                if(result == null){
                    ...
                    for(int i =0; i< jsonArray.length(); i++) {
                        ...
                        Log.d("House(3)" + i + ":", houseList.get(i).toString());
                    }
                }

                adapter = new ListViewAdapter(AfterSearch.this, R.layout.item, houseList, reviewList);
                adapter.setReviewExist(false);
                listView.setAdapter(adapter);
